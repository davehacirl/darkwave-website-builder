      ...
      <div className="section-container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Louis Hackett has <span className="text-gradient">great</span> dance 
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center">
            <Button 
              className="bg-white text-black text-lg px-8 py-6"
        ...
        <div className="hidden md:block absolute top-1/3 right-10 transform -translate-y-1/2">
          <div className="relative">
            <BarChart3 className="h-14 w-14 text-white/70 animate-pulse-slow" style={{ animationDelay: '1s' }} />
          </div>
        </div>
